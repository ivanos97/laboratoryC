...
namespace Laboratory56.Models
{
    class Werehouse_registration_card
    {
        ...
        public Werehouse_registration_card(int id_karta_ucheta, string priem_nakl, string type_inventar, string inventar, int kolich_yedinitsa, string raskhod_nakl)
        {
